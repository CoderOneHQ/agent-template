...
class FreeRoamingAgent:
	...
	def next_move(self, game_state, player_state):
		...
		return self.move_to_tile(player_state.location, random.choice(free_tiles)) if free_tiles else ''
	...
	def move_to_tile(self, location, tile):
		...
		if diff == (0,1):		return 'u'
		elif diff == (1,0):		return 'r'
		elif diff == (0,-1):	return 'l'
		elif diff == (-1,0):	return 'd'
		else:					return ''
